...
> - **Item infit statistics are in general no adequate means to evaluate fit of the Rasch model.**
...
- Result:
    ...
    * It is not at all clear that the Rasch model holds now
    * In fact, it does not!
    
## 
![res2](img/LR_plot.png)

## Itemfit: Simulation II
<div class="notes">
...
- Result:
    ...
    * Unidimensional Rasch model: Shows low reliability similar to reviewed articles (about .5 - .6)
