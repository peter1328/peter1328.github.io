...
```{r, message = FALSE}
load('../data/sim_2pl1.rda')
load('../data/sim_2pl3.rda')
load('../data/sim_2pl5.rda')
load('../data/sim_mult.rda')
load('../data/sim_rasch.rda')
load('../data/sim_removal.rda')
```
...
## Simulation results
```{r}
sm_mult <- summarize(sim_mult)
```

```{r, warning = FALSE, fig.width = 7, fig.height = 7}
visualize(sm_mult, ylim = c(0, .5))
```
